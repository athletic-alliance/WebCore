...
export const AuthProvider = ({children}: { children: React.ReactNode }) => {
    ...
    const [authenticationPending, setAuthenticationPending] = useState<boolean>(true);

    let signIn = (credentials: Credentials) => {
        return authProvider.signIn(credentials).then((result: AxiosResponse<AuthResponse>) => {
    ...
    useEffect(() => {
        ...
        async function checkToken() {
            await asyncLocalStorage.getItem(AUTHTOKENKEY)
    ...
    const value = {token, signIn, signOut, authenticationPending, isAuthenticated};
